...
Route::get('/kepegawaian/login', [AuthController::class, 'showLoginForm'])->name('kepegawaian.login');
Route::get('/kepegawaian/register', [AuthController::class, 'showRegisterForm'])->name('kepegawaian.registerForm');
Route::post('/kepegawaian/login', [AuthController::class, 'login'])->name('kepegawaian.login.post');
Route::post('/register', [AuthController::class, 'register'])->name('kepegawaian.register');
Route::post('/register_institusi', [AuthController::class, 'register_institusi'])->name('sindikat.register_institusi');
Route::get('/logout', [AuthController::class, 'logout'])->name('kepegawaian.logout');
Route::get('/logout_sindikat', [AuthController::class, 'logout_sindikat'])->name('sindikat.logout');
...
Route::get('captcha_login', [CaptchaController::class, 'generate_login'])->name('captcha_login');
