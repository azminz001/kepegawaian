                ...
                <div class="card rounded">
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <div class="ms-2">
                                <h6 class="card-title mb-0">Daftar Arsip {{$nama}} Sindikat</h6>            
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                                    ...
                                    @forelse ($arsips as $key => $arsip)
                                        <tr>
                                            ...
                                            <td style="word-wrap: break-word;white-space: normal;">
                                                ...
                                                <span class="badge bg-success">{{($arsip->jenis == 1) ? 'Materi' : 'Dokumentasi'}}</span>
                                            </td>
                            ...
                            <small>Menampilkan {{$arsips->count()}} data dari total {{$arsip_count}} Arsip {{$nama}}.</small>
                        </div>
                    </div>
                </div>
            </div>
