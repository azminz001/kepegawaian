...
class RiwayatPekerjaanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with(['success' => 'Data Riwayat Pekerjaan Baru berhasil Disimpan']);
    }
    ...
    {
        $pekerjaan = RiwayatPekerjaan::findOrFail($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->back()->with(['success' => 'Data Riwayat Pekerjaan berhasil Disimpan']);
    }
    ...
    public function destroy($id)
    {
        ...
        if ($pekerjaan) {
            ...
            return redirect()->back()->with('error', 'Riwayat Pekerjaan tidak ditemukan.');
        }
    }
}
