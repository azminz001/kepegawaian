        ...
        <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
          <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
            <div class="mb-3">
              ...
              <img src="{{ asset('assets/images/logo_rsud_brebes.jpg') }}" class="wd-80 ht-80 rounded-circle" alt="" srcset="">
              @else
              @if (!isset($pegawai) || !isset($pegawai->foto))
                <img src="{{ asset('assets/images/user-icon.png') }}" class="wd-80 ht-80 rounded-circle" alt="" srcset="">
              @else
                <img src="{{ asset('storage/foto_pegawai/'.$pegawai->nip_nipppk_nrpk_nrpblud.'/'.$pegawai->foto) }}" class="wd-80 ht-80 rounded-circle" style="object-fit: cover" alt="...">
              @endif
              @endif
            </div>
          ...
          <ul class="list-unstyled p-1">
            ...
            <li class="dropdown-item py-2">
              <a href="{{ url('/kepegawaian/pegawai/profil') }}"  class="text-body ms-0">
            ...
            @endif
            <li class="dropdown-item py-2">
              <a href="javascript:;"  data-bs-target="#resetPassword" data-bs-toggle="modal" class="text-body ms-0">
            ...
            <li class="dropdown-item py-2">
              <a href="/logout_sindikat" class="text-body ms-0">
  ...
  <div class="modal-dialog modal-sm">
      <div class="modal-content">
          <div class="modal-header">
            ...
            <form action="{{ route('pengguna.ubah_password', Auth::user()->id) }}" method="post">
              @csrf
              @method('PUT')
                      ...
                      <div class="row">
                          <div class="col-12">
                              <div class="mb-3">
                                  ...
                                  <input type="password" class="form-control" name="password" autocomplete="off" id="password" placeholder="Password Baru" required>
                              </div>
                          </div>
                          <div class="col-12">
                              <div class="mb-3">
                                  <label for="" class="form-label">Konfirmasi Password </label>
                                  <input type="password" class="form-control" autocomplete="off" id="confirm_password" placeholder="Konfirmasi Password" required onkeyup="validate_password()">
                                  <span id="wrong_pass_alert"></span>
                              </div>
                          </div>
                      </div>
                  </div>
                  <button type="submit" id="simpanButton" class="btn btn-success me-2" disabled>Simpan</button>
              </div>
          </form>
      </div>
  </div>
