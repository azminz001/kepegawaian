    ...
    <nav class="navbar top-navbar">
      <div class="container">
        <div class="navbar-content">
          <a href="{{url('/sindikat')}}" class="navbar-brand">
            SIN<span>DIKAT</span>
          </a>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="wd-30 ht-30 rounded-circle" src="{{ asset('assets/images/user-icon.png') }}" alt="profile">
                &nbsp;
                <span>Masuk</span>
              </a>
              <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                <ul class="list-unstyled p-1">
                  <li class="dropdown-item py-2">
                    <a href="{{ url('/sindikat/login') }}" class="text-body ms-0">
                      <i class="me-2 icon-md mdi mdi-login"></i>
                      <span>Login</span>
                    </a>
                  </li>
                  <li class="dropdown-item py-2">
                    <a href="{{ url('/sindikat/register') }}" class="text-body ms-0">
                      <i class="me-2 icon-md mdi mdi-office-building"></i>
                      <span>Daftar Institusi</span>
                    </a>
                  </li>
                </ul>
              </div>
    ...
    <nav class="bottom-navbar">
      <div class="container">
        <ul class="nav page-navigation">
          <li class="nav-item {{ active_class(['sindikat']) }}">
            <a class="nav-link" href="{{ url('/sindikat') }}">
              <span class="menu-title">HOME</span>
            </a>
          </li>
          <li class="nav-item {{ active_class(['sindikat/profil_diklat']) }}">
            <a href="#" class="nav-link">
              <span class="menu-title">PROFIL</span>
              <i class="link-arrow"></i>
            </a>
            <div class="submenu">
              <ul class="submenu-item" style="margin-top:-12px">
                <li class="category-heading">Profil & SK</li>
                <li class="nav-item"><a class="nav-link {{ active_class(['']) }}" href="#">Sindikat</a></li>
                <li class="nav-item"><a class="nav-link {{ active_class(['sindikat/profil_diklat']) }}" href="{{ url('/sindikat/profil_diklat') }}">Diklat</a></li>
                <li class="nav-item"><a class="nav-link {{ active_class(['email/read']) }}" href="{{ url('/sindikat/profil_litbang') }}">Litbang</a></li>
                <li class="nav-item"><a class="nav-link {{ active_class(['apps/chat']) }}" href="{{ url('/sindikat/struktur_organisasi') }}">Struktur Organisasi</a></li>
                <li class="nav-item"><a class="nav-link {{ active_class(['apps/chat']) }}" href="{{ url('/apps/chat') }}">Rumah Sakit Pendidikan (RSP)</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="submenu">
              <ul class="submenu-item" style="margin-top:-12px">
                <li class="category-heading">Pendidikan dan Pelatihan</li>
                <li class="nav-item"><a class="nav-link {{ active_class(['email/inbox']) }}" href="{{ url('/email/inbox') }}">Panduan</a></li>
                <li class="nav-item"><a class="nav-link {{ active_class(['email/read']) }}" href="{{ url('/sindikat/clinical_instructure') }}">Profil Clinical Instructure</a></li>
                <li class="category-heading">Arsip</li>
                <li class="nav-item"><a class="nav-link {{ active_class(['apps/chat']) }}" href="{{ url('/apps/chat') }}">Materi</a></li>
                <li class="nav-item"><a class="nav-link {{ active_class(['apps/chat']) }}" href="{{ url('/apps/chat') }}">Dokumentasi</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link">
              <span class="menu-title">LITBANG</span>
              <i class="link-arrow"></i>
            </a>
            <div class="submenu">
              <ul class="submenu-item" style="margin-top:-12px">
                <li class="category-heading">Penelitian dan Pengembangan</li>
                <li class="nav-item"><a class="nav-link {{ active_class(['email/inbox']) }}" href="{{ url('/email/inbox') }}">Program</a></li>
                <li class="nav-item"><a class="nav-link {{ active_class(['email/read']) }}" href="{{ url('/email/read') }}">SK Komite Etik Penelitian</a></li>
                <li class="nav-item"><a class="nav-link {{ active_class(['apps/chat']) }}" href="{{ url('/apps/chat') }}">SOP Etik Penelitian</a></li>
                <li class="category-heading">Arsip</li>
                <li class="nav-item"><a class="nav-link {{ active_class(['apps/chat']) }}" href="{{ url('/apps/chat') }}">Materi</a></li>
                <li class="nav-item"><a class="nav-link {{ active_class(['apps/chat']) }}" href="{{ url('/apps/chat') }}">Dokumentasi</a></li>
              </ul>
              <a href="{{route('sindikat.litbang.login')}}" class="d-grid gap-2"><button class="btn btn-warning btn-sm mb-2 mx-2"><span class="mdi mdi-file-check mx-2"></span>Permohonan Litbang</button></a>
            </div>
          </li>

          <li class="nav-item">
            <a href="#" class="nav-link">
              <span class="menu-title">IHT</span>
              <i class="link-arrow"></i>
            </a>
            <div class="submenu">
              <ul class="submenu-item" style="margin-top:-12px">
                <li class="category-heading">In House Training</li>
                <li class="nav-item"><a class="nav-link {{ active_class(['email/inbox']) }}" href="{{ url('/email/inbox') }}">Program</a></li>
                <li class="nav-item"><a class="nav-link {{ active_class(['email/read']) }}" href="{{ url('/email/read') }}">SOP</a></li>
                <li class="category-heading">Arsip</li>
                <li class="nav-item"><a class="nav-link {{ active_class(['email/read']) }}" href="{{ url('/email/read') }}">Materi</a></li>
                <li class="nav-item"><a class="nav-link {{ active_class(['apps/chat']) }}" href="{{ url('/apps/chat') }}">Dokumentasi</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link">
              <span class="menu-title">STUDI BANDING</span>
              <i class="link-arrow"></i>
            </a>
            <div class="submenu">
              <ul class="submenu-item" style="margin-top:-12px">
                <li class="category-heading">Studi Banding</li>
                <li class="nav-item"><a class="nav-link {{ active_class(['email/inbox']) }}" href="{{ url('/email/inbox') }}">Program</a></li>
                <li class="nav-item"><a class="nav-link {{ active_class(['email/read']) }}" href="{{ url('/email/read') }}">SOP</a></li>
                <li class="category-heading">Arsip</li>
                <li class="nav-item"><a class="nav-link {{ active_class(['email/read']) }}" href="{{ url('/email/read') }}">Materi</a></li>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              <span class="menu-title">PENG. MASYARAKAT</span>
              <i class="link-arrow"></i>
            </a>
            <div class="submenu">
              <ul class="submenu-item" style="margin-top:-12px">
                <li class="category-heading">Pengabdian Masyarakat</li>
                <li class="nav-item"><a class="nav-link {{ active_class(['email/inbox']) }}" href="{{ url('/email/inbox') }}">Program</a></li>
                <li class="category-heading">Arsip</li>
                <li class="nav-item"><a class="nav-link {{ active_class(['apps/chat']) }}" href="{{ url('/apps/chat') }}">Dokumentasi</a></li>
              </ul>
