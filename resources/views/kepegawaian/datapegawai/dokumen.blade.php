...
<nav class="page-breadcrumb">
    <ol class="breadcrumb breadcrumb-arrwo">
        ...
        <li class="breadcrumb-item active" aria-current="page">Dokumen Pegawai</li>
    </ol>
</nav>
                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <div class="ms-2">
                                    <h6 class="card-title mb-0"><i class="mdi mdi-file-document icon-lg mx-2"></i> Data Dokumen Pendukung Pegawai</h6>     
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form onsubmit="return confirm('Apakah Anda Yakin mengahapus data anak {{$dokumen->nama}}?');" action="{{ route('dokumen.destroy', $dokumen->id) }}" method="POST">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="alert alert-info mt-2" role="alert">
                                <h5><i data-feather="alert-circle"></i> Informasi</h5>
                                <p class="mt-2">Anda dapat mengunggah dokumen pendukung seperti: KTP, KK, NPWP, Sertifikat SIP / STR dll pada halaman ini.</p>
                            </div>
                            <input type="hidden" name="pegawai_id" value="{{$pegawai->id}}">
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    <label for="" class="form-label">Nama Dokumen*</label>
                                    <input type="text" class="form-control" name="nama" placeholder="contoh: KTP John Doe / NPWP John Doe" required>
                                    @error('nama')
                                        <code>{{$message}}</code>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" name="file" id="myDropify" required>
                                    @error('file')
                                        <code>{{$message}}</code>
                                    @enderror
                                </div>
...
<div class="modal fade" id="bukaDokumen" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Dokumen Pegawai</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="btn-close"></button>
            </div>
            <div class="modal-body">
                <div class="container">
...
<script>
    $(document).ready(function() {
        ...
        $('#bukaDokumen').on('show.bs.modal', function(event) {
            ...
            var url = baseUrl + '/kepegawaian/dokumen/edit/' + dokumenId;
