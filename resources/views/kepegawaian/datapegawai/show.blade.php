                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between flex-column flex-md-row">
                            <div class="d-flex align-items-center">
                                <div class="ms-2">
                                    <h6 class="card-title mb-0"><i class="btn-icon-prepend mx-2" data-feather="user"></i> Biodata Diri Pegawai</h6>            
                                </div>
                            </div>
                            <div class="mt-3 mt-md-0">
                                <form onsubmit="return confirm('Apakah Anda Yakin mengahapus Pegawai {{$pegawai->nama}}?');" action="{{ route('data_pegawai.destroy', $pegawai->id) }}" method="POST">
                                    <a class="btn btn-xs btn-success btn-icon-text" data-bs-toggle="modal" data-bs-target="#editPegawai"><i class="btn-icon-prepend" data-feather="edit"></i> Ubah Data Pegawai</a>
                                    @csrf
                                    @method('DELETE')
                                    <button class="btn btn-xs btn-danger btn-icon-text"><i class="btn-icon-prepend" data-feather="trash-2"></i> Hapus Data Pegawai</button>
                                </form>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <select name="status_pegawai" class="form-control" id="">
                                        <option disabled selected value>- Ubah Status Pegawai -</option>
                                        <option value="0">AKTIF</option>
                                        <option value="1">TIDAK AKTIF</option>
                                        <option value="2">MUTASI</option>
                                        <option value="3">PENSIUN</option>
                                        <option value="4">DIBERHENTIKAN</option>
                                    </select>
                                </div>
                            </div>
                        </div>
