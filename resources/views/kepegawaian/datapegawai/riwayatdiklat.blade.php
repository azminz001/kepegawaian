...
<nav class="page-breadcrumb">
    <ol class="breadcrumb breadcrumb-arrwo">
        ...
        <li class="breadcrumb-item active" aria-current="page">Riwayat Diklat Pegawai</li>
    </ol>
</nav>
                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <div class="ms-2">
                                    <h6 class="card-title mb-0"><i class="mdi mdi-certificate icon-lg mx-2"></i> Data Riwayat Diklat Pegawai</h6>     
                                </div>
                            </div>
                            <div class="pull-right">
                                <a class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#createRiwayatDiklat">Tambah Riwayat Diklat</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($riwayat_diklats as $key => $riwayat_diklat)
                                        <tr>
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <select name="jenis_diklat" class="form-control" required>
                                        ...
                                        <option value="Kursus/Bootcamp">Kursus/Bootcamp</option>
